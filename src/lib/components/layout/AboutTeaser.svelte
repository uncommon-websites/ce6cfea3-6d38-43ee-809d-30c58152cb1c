...
<script lang="ts">
  ...
  name: "George Eliadis",
  role: "CEO & Founder",
  image: "/generated/image-a-confident-friendly-male-founder-in-his.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"This all started with a sticky-note dispatcher and a 40-person board. We built Probook so every dispatcher can work like the best—even on the busiest day."`}
    />
